...
{
    public class RCS1018RemoveAccessibilityModifiersTests : AbstractCSharpFixVerifier
    {
        ...
        {
            return base.UpdateOptions(options).WithEnabled(AnalyzerOptions.RemoveAccessibilityModifiers.Descriptor);
        }
