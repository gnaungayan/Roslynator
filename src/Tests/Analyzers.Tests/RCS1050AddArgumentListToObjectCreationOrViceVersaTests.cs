...
namespace Roslynator.CSharp.Analysis.Tests
{
    public class RCS1050AddArgumentListToObjectCreationOrViceVersaTests : AbstractCSharpFixVerifier
    {
        ...
        public override DiagnosticAnalyzer Analyzer { get; } = new AddArgumentListToObjectCreationOrViceVersaAnalyzer();
...
", options: Options.WithEnabled(AnalyzerOptions.RemoveArgumentListFromObjectCreation.Descriptor));
        }
