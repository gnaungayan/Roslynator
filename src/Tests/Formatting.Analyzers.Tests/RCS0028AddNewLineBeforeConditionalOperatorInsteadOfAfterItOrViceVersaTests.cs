...
namespace Roslynator.Formatting.CSharp.Tests
{
    public class RCS0028AddNewLineBeforeConditionalOperatorInsteadOfAfterItOrViceVersaTests : AbstractCSharpFixVerifier
    {
        ...
        public override DiagnosticAnalyzer Analyzer { get; } = new AddNewLineBeforeConditionalOperatorInsteadOfAfterItOrViceVersaAnalyzer();
...
", options: Options.WithEnabled(AnalyzerOptions.AddNewLineAfterConditionalOperatorInsteadOfBeforeIt.Descriptor));
        }
